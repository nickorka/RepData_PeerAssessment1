...
```{r histogrma total steps per day with mean and median, fig.width=12, message=FALSE}
require(dplyr)
...
```{r barplot total steps per day with mean and median, fig.width=12}
...
```{r prepare time intervals, message=FALSE, fig.width=12}
require(dplyr)
...
```{r na replacement, cache=TRUE, message=FALSE}
...
```{r new activity summary}
str(adjusted_activity)
```

### 4. Make a histogram of the total number of steps taken each day and Calculate and report the mean and median total number of steps taken per day.
```{r plot new hist and mean/median per day, fig.width=12}
